...
New Balance 990v6 スニーカーは、ハイブリッドスニーカーの王者と呼ばれるにふさわしい性能を持ちます。走行性、クッション性、そしてスタイリッシュなデザイン。新しい時代のランニングを体験するなら、コレ一台で十分です。`,
  ...
  },
  {
    ...
    originalUrl: 'https://www.amazon.co.jp/dp/B0CKZ7XYPQ',
    asin: 'B0CKZ7XYPQ',
...
Nintendo Switch 2 本体は、ゲームファンには必須のアイテムとなり得ます。高性能かつ軽量な本体で、さまざまなゲームを楽しむことができます。ただし、価格が上がっているため、購入の際には十分な検討が必要です。`,
    ctaTitle: `＼ 今なら最安値！AmazonでNintendo Switch 2 本体をチェック ／`,
    affiliateLink: 'https://www.amazon.co.jp/dp/B0CKZ7XYPQ?tag=mattan0290c-22',
